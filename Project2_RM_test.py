...
class ConvexHullP2Test(unittest.TestCase):
    ...
    def test_colinear(self):
        ...
        "self.assert..." is ensuring that we want the result to have five points in our answer (that's how we handle it, non-minimal hull) and that the return is right.
        """
